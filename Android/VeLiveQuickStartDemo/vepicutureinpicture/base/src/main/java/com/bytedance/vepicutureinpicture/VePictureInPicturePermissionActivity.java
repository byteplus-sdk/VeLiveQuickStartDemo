...
public class VePictureInPicturePermissionActivity extends AppCompatActivity {
    private static final String EXTRA_PIP_PERMISSION_KEY = "extra_pip_permission_key";

    private VePictureInPicturePermission mPermission;

    static void intentInto(Context context, String key) {
        Intent intent = new Intent(context, VePictureInPicturePermissionActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPermission = VePictureInPicturePermission.get(key);
        if (mPermission != null) {
