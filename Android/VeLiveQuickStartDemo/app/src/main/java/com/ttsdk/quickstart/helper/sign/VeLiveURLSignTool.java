...
public class VeLiveURLSignTool {
    ...
    private static final String host = "open.byteplusapi.com";
    private static final String region = "ap-singapore-1";
    ...
    public static String hash(String strSrc) {// Hash sha 256 algorithm
        MessageDigest md;
        String strDes;
